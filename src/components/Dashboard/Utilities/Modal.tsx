...
const ModalContent: React.FC<{
  ...
  return (
    ...
    >
      <section className="relative bg-slate-200 dark:bg-slate-900 max-w-lg w-full rounded-lg p-3 sm:p-5 flex flex-col justify-start overflow-y-auto max-h-[90vh]">
        <button
          aria-label="close alert"
          className="absolute right-3 sm:right-4"
          onClick={onClose}
        >
          <IoClose className="w-5 h-5" /> {/* Replace img with IoClose */}
        </button>
